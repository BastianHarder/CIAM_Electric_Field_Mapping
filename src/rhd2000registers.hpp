...
public:
    ...
    int createCommandListRegisterConfig(std::vector<uint16_t> &commandList, bool calibrate);
    int createCommandListTempSensor(std::vector<uint16_t> &commandList);
    int createCommandListUpdateDigOut(std::vector<uint16_t> &commandList);
    int createCommandListZcheckDac(std::vector<uint16_t> &commandList, double frequency, double amplitude);
	int createCommandListConvert(std::vector<uint16_t> &commandList);
