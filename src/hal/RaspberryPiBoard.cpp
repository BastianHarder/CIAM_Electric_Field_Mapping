...
RaspberryPiBoard::RaspberryPiBoard() {
...
void RaspberryPiBoard::initSpi(uint32_t spiSpeedHz) {
...
void RaspberryPiBoard::spi_transfer(vector<uint16_t>& commandList, vector<uint16_t>& receivedList) {
