...
{
    constexpr uint8_t A_PWR_VALUE = 64;
    aPwr.resize(A_PWR_VALUE);
...
void Rhd2000Registers::defineSampleRate(const double newSampleRate)
{
...
// if enabled.
void Rhd2000Registers::setFastSettle(const bool enabled)
{
...
void Rhd2000Registers::enableAux1(const bool enabled)
{
    adcAux1En = (enabled ? 1 : 0);
}

// Enable or disable ADC auxiliary input 2
void Rhd2000Registers::enableAux2(const bool enabled)
{
    adcAux2En = (enabled ? 1 : 0);
}

// Enable or disable ADC auxiliary input 3
void Rhd2000Registers::enableAux3(const bool enabled)
{
    adcAux3En = (enabled ? 1 : 0);
}

// Enable or disable DSP offset removal filter
void Rhd2000Registers::enableDsp(const bool enabled)
{
    dspEn = (enabled ? 1 : 0);
}
...
double Rhd2000Registers::setDspCutoffFreq(const double newDspCutoffFreq)
{
    int n;
...
void Rhd2000Registers::enableZcheck(const bool enabled)
{
    zcheckEn = (enabled ? 1: 0);
}

// Power up or down impedance checking DAC
void Rhd2000Registers::setZcheckDacPower(const bool enabled)
{
...
void Rhd2000Registers::setZcheckScale(const ZcheckCs scale)
{
    switch (scale) {
        case ZcheckCs100fF:
...
void Rhd2000Registers::setZcheckPolarity(const ZcheckPolarity polarity)
{
    switch (polarity) {
...
int Rhd2000Registers::setZcheckChannel(const int channel)
{
...
void Rhd2000Registers::setAmpPowered(const int channel, const bool powered)
{
    if (channel >= 0 && channel <= 63) {
...
int Rhd2000Registers::getRegisterValue(const int reg) const
{
    int regout;
...
double Rhd2000Registers::rH1FromUpperBandwidth(const double upperBandwidth) const
{
...
// bandwidth value (in Hz).
double Rhd2000Registers::rH2FromUpperBandwidth(const double upperBandwidth) const
{
    double log10f = log10(upperBandwidth);
...
// bandwidth value (in Hz).
double Rhd2000Registers::rLFromLowerBandwidth(const double lowerBandwidth) const
{
...
double Rhd2000Registers::upperBandwidthFromRH1(const double rH1) const
{
    double a, b, c;
...
double Rhd2000Registers::upperBandwidthFromRH2(const double rH2) const
{
    double a, b, c;
...
int Rhd2000Registers::createRhd2000Command(const Rhd2000CommandType commandType)
{
    switch (commandType) {
...
int Rhd2000Registers::createRhd2000Command(const Rhd2000CommandType commandType, const int arg1)
{
    switch (commandType) {
...
int Rhd2000Registers::createRhd2000Command(const Rhd2000CommandType commandType, const int arg1, const int arg2)
{
    switch (commandType) {
...
int Rhd2000Registers::createCommandListRegisterConfig(vector<uint16_t> &commandList, const bool calibrate)
{
...
// Returns the length of the command list.
int Rhd2000Registers::createCommandListZcheckDac(vector<uint16_t> &commandList, const double frequency,const double amplitude)
{
    int i, period, value;
    double t;
    const double Pi = 2*acos(0.0);
